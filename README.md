...
| Sign In | Sign Up | My Maps | Create Map |
|--------|---------|---------|------------|
| ![Sign In](screenshots/signin.png) | ![Sign Up](screenshots/signup.png) | ![Dashboard](screenshots/dashboard.png) | ![Create Map](screenshots/create_map.png) |

| Map View | Create Marker |
|----------|---------------|
| ![Map](screenshots/map.png) | ![Create Marker](screenshots/create_marker.png) |
